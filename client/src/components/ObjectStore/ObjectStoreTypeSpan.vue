...
const MESSAGES = {
    ...
    rucio: "This is a Galaxy storage location based on the RUCIO system https://rucio.cern.ch/.",
    irods: "This is a Galaxy storage location based on the iRODS system.",
};
